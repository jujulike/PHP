                    ...
                    <div class="widget-body">
                        <fieldset>
							<div class="widget-head am-cf">
                                <div class="widget-title am-fl">修改小程序模板</div>
                            </div>
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="template[app_type]" value="10" data-am-ucheck
                                            <?= $model['app_type']['value']===10?'checked':'' ?>> 餐饮
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="template[app_type]" value="20" data-am-ucheck 
											<?= $model['app_type']['value']===20?'checked':'' ?>> 商城
                                    </label>
                                </div>
                            </div>
							<div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" class="tpl-form-input" name="template[id]" value="<?= $model['id'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">版本号 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="template[user_version]" value="<?= $model['user_version'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">版本描述 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="template[user_desc]" value="<?= $model['user_desc'] ?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
