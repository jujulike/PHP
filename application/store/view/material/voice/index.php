        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-cf">语音素材列表</div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="am-text-middle">
										<a href="<?= './uploads/'.$item['file_name'] ?>" title="点击查看大图" target="_blank">
                                            <img src="./assets/store/img/voice.jpg" width="50" height="50">
                                        </a>
									</td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= url('material.voice/edit',
...
<script>
    $(function () {
        // 删除元素
        var url = "<?= url('material.voice/delete') ?>";
