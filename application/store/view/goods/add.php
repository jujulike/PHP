                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="goods[goods_name]" value="" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                            ...
                                            <tr v-for="(item, index) in spec_list">
												...
												<td>
                                                    <input type="number" class="ipt-w80" name="purchase_price"
                                                           v-model="item.form.purchase_price">
                                                </td>
                                                <td>
                            ...
                            <div class="goods-spec-single">
								...
								<?php endif; ?>
								<div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label">进货价格 </label>
                                    <div class="am-u-sm-9 am-u-end">
