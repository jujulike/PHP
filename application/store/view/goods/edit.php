                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
							...
							<div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">转发大图 </label>
                                <div class="am-u-sm-9 am-u-end">
									<div class="am-form-file">
										<button type="button"
										...
										<div class="uploader-list am-cf">
											<div class="file-item">
                                                <img src="<?= $model['share']['file_path'] ?>">
                                                <input type="hidden" name="goods[share_image]"
                                                           value="<?= $model['share_image'] ?>">
                                                <i class="iconfont icon-shanchu file-item-delete"></i>
                                            </div>
										</div>
									</div>
									<div class="help-block am-margin-top-sm">
										<small>尺寸500x400像素以上，大小2M以下</small>
									</div>
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div id="many-app" v-cloak class="goods-spec-many am-form-group"
                                 v-bind:style="<?= $model['spec_type'] == 20 ? "{display:'block'}" : "{display:'none'}" ?>">
                                <div class="goods-spec-box am-u-sm-9 am-u-sm-push-2 am-u-end">
                                    ...
                                    <div v-if="spec_list.length > 0" class="goods-sku am-scrollable-horizontal">
                                        ...
                                        <div class="spec-batch am-form-inline">
											...
											<?php if($store['wxapp']['app_type']['value']==20):?>
											<div class="am-form-group">
                                                <input type="number" v-model="batchData.goods_no" placeholder="商品编码">
                                            </div>
											<?php endif; ?>
											<div class="am-form-group">
                                                <input type="number" v-model="batchData.purchase_price" placeholder="进货价">
                                            </div>
                                            <div class="am-form-group">
                                     ...
                                     am-margin-bottom-xs am-text-nowrap">
                                            ...
                                            <tr v-for="(item, index) in spec_list">
												...
												<?php if($store['wxapp']['app_type']['value']==20):?>
												<td>
                                                    <input type="number" class="ipt-w80" name="goods_no"
                                                           v-model="item.form.goods_no" v-model="item.form.goods_no">
                                                </td>
												<?php endif; ?>
												<td>
                                                    <input type="number" class="ipt-w80" name="purchase_price"
                                                        :value="item.form.purchase_price" v-model="item.form.purchase_price">
                                                </td>
                                                <td>
                                                    <input type="number" class="ipt-w80" name="goods_price"
                                                        :value="item.form.goods_price" v-model="item.form.goods_price" required>
                                                </td>
                                                <td>
                                                    <input type="number" class="ipt-w80" name="line_price"
                                                        :value="item.form.line_price" v-model="item.form.line_price">
                                                </td>
                                                <td>
                                                    <input type="number" class="ipt-w80" name="stock_num"
                                                        :value="item.form.stock_num" v-model="item.form.stock_num" required>
                                                </td>
												<?php if($store['wxapp']['app_type']['value']==20):?>
												<td>
                                                    <input type="number" class="ipt-w80" name="goods_weight"
                                                        :value="item.form.goods_weight" v-model="item.form.goods_weight" required>
                                                </td>
												<?php endif; ?>
                                            </tr>
                                            </tbody>
                            ...
                            <div class="goods-spec-single"
								...
								<?php endif; ?>
								<div class="am-form-group">
                                    <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">进货价格 </label>
                                    <div class="am-u-sm-9 am-u-end">
                                        <input type="number" class="tpl-form-input" name="goods[sku][purchase_price]"
                                               value="<?= $model['spec'][0]['purchase_price'] ?>">
                                    </div>
                                </div>
                                <div class="am-form-group">
