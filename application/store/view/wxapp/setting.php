                    ...
                    <div class="widget-body">
						...
						<?php if($wxapp['is_empower']['value']== 0): ?>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">创建微信小程序</div>
                            </div>
							<div class="widget-body am-cf">
								...
								<div style="background:#eeeeee;margin-left:100px;border-radius:10px;padding:20px;" class="am-u-sm-6 am-u-md-6 am-u-lg-3">
									<div style="text-align:center;">我还没有微信小程序</div>
									<div style="margin-top:20px;text-align:center;">
										<a class="am-btn am-btn-default am-btn-success" href="<?= url('wxapp.register/index') ?>">
                                            快速注册
                                        </a>
									</div>
								</div>
							...
							<div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
									...
									<?php if(empty($wxapp['serve_domain'])):?>
										<small>服务器域名必须设置，否则无法正常使用小程序。<a href="<?= url('wxapp/servedomain') ?>">我要设置</a></small>
									<?php endif; ?>
                                </div>
                            </div>
							<div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    ...
                                    <div class="help-block">
                                        <small>收藏提醒显示位置：小程序首页面顶端位置。
                                        </small>
                                    </div>
                                </div>
                            </div>
							<div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label">虚拟用户 </label>
                                <div class="am-u-sm-9">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="wxapp[is_virtuals]" value="1" data-am-ucheck
                                            <?= $wxapp['is_virtuals'] ? 'checked' : '' ?>> 开启
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="wxapp[is_virtuals]" value="0" data-am-ucheck
                                            <?= $wxapp['is_virtuals'] ? '' : 'checked' ?>> 关闭
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
