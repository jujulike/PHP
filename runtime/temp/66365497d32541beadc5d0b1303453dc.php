<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\www\ppp\PHP/application/store\view\user\grade\index.php";i:1571820673;s:56:"D:\www\ppp\PHP\application\store\view\layouts\layout.php";i:1576159280;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                <div class="widget-head am-cf">
                    <div class="widget-title am-cf">会员等级</div>
                </div>
                    ...
                    <div class="am-u-sm-12">
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
									 <td class="am-text-middle"><?= $item['user_grade_id'] ?></td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= url('user.grade/edit',
                                                ['user_grade_id' => $item['user_grade_id']]) ?>">
                                                <i class="am-icon-pencil"></i> 编辑
                                            </a>
                                            <a href="javascript:;" class="item-delete tpl-table-black-operation-del"
                                               data-id="<?= $item['user_grade_id'] ?>">
...
<script>
    $(function () {
        ...
        $('.item-delete').delete('user_grade_id', url);
