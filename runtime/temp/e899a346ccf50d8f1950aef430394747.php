<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"D:\www\ppp\PHP/application/store\view\setting\trade.php";i:1575360313;s:56:"D:\www\ppp\PHP\application\store\view\layouts\layout.php";i:1576159280;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                                ...
                                <div class="am-u-sm-9 am-input-group">
                                    <div class="am-u-sm-7">
                                        <input type="number" class="am-form-field" name="trade[order][refund_days]"
                                               value="<?= $values['order']['refund_days'] ?>" 
											   pattern="^(0|\+?[1-9][0-9]*)$" required>
                                    </div>
                                    <label class="am-u-sm-5 am-form-label am-text-left">天内允许申请售后</label>
                                    <div class="help-block am-u-sm-12">
