<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\www\ppp\PHP/application/store\view\food\table\index.php";i:1572483197;s:56:"D:\www\ppp\PHP\application\store\view\layouts\layout.php";i:1576159280;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    <td class="am-text-middle">
                                        <p class="item-title"><?= $item['table_id'] ?></p>
                                    </td>
									<td class="am-text-middle">
                                        <a href="assets/images/table/<?= $item['table_id'] ?>.png"
                                           title="点击查看大图" target="_blank">
                                            <img src="assets/store/img/code.png" width="50" height="50" alt="商品图片">
                                        </a>
                                    </td>
                                    <td class="am-text-middle"><?= $item['table_name'] ?></td>
                                    <td class="am-text-middle"><?= $item['sort'] ?></td>
                                    <td class="am-text-middle"><?= $item['create_time'] ?></td>
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <a href="<?= url('food.table/edit',
...
<script>
    $(function () {
        ...
        // 删除元素
        var url = "<?= url('food.table/delete') ?>";
        $('.item-delete').delete('table_id', url);
